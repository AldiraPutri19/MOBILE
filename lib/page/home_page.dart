...
import 'package:tugas_uas/model_main.dart';
import 'package:tugas_uas/page/detail_page.dart';
...
class _HomeState extends State<HomePage> {
  Future<List<ModelMain>> readJsonData() async {
    final jsonData = await root_bundle.rootBundle.loadString('assets/pahlawan_nasional.json');
      ...
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Sejarah Pahlawan',
            style: TextStyle(
              color: Color(0xFFC8A2C8), // Warna lilac
